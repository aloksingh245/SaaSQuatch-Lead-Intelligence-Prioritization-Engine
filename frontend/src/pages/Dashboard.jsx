...
const EMPTY_FILTERS = {
  ...
  hasEmail: '', hasDecisionMaker: '', jobId: '',
};
...
export default function Dashboard() {
  ...
  const [filters, setFilters] = useState(() => {
    ...
    return { ...EMPTY_FILTERS, jobId: initialJobId };
  });
  ...
  useEffect(() => {
    LeadsAPI.getRecentJobs().then(setJobs).catch(() => {});
  }, []);
